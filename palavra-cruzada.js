function verificar_q1() {
    ...
    if (rom.toUpperCase() == "ROM") {
        ...
        romO.innerHTML = `O`;
        romM.innerHTML = `M`;
        inp_rom.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_rom.style.border = 'solid 2px red';
        alert(`a resposta da questão 1 está incorreta!`)
    }
}
...
function verificar_q2() {
    ...
    if (dualCore.toUpperCase() == "DUAL CORE") {
        ...
        inp_dualCore.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_dualCore.style.border = 'solid 2px red';
        alert(`a resposta da questão 2 está incorreta!`)
    }
}
...
function verificar_q3() {
    ...
    if (registradores.toUpperCase() == "REGISTRADORES") {
        ...
        inp_registradores.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_registradores.style.border = 'solid 2px red';
        alert(`a resposta da questão 3 está incorreta!`)
    }
}
...
function verificar_q4() {
    ...
    if (quadCore.toUpperCase() == "QUAD CORE") {
        ...
        inp_quadCore.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_quadCore.style.border = 'solid 2px red';
        alert(`a resposta da questão 4 está incorreta!`)
    }
}
...
function verificar_q5() {
    ...
    if (ram.toUpperCase() == "RAM") {
        ...
        ramA.innerHTML = `A`;
        romM.innerHTML = `M`;
        inp_ram.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_ram.style.border = 'solid 2px red';
        alert(`a resposta da questão 5 está incorreta!`)
    }
}
...
function verificar_q6() {
    ...
    if (threads.toUpperCase() == "THREADS") {
        ...
        inp_threads.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_threads.style.border = 'solid 2px red';
        alert(`a resposta da questão 6 está incorreta!`)
    }
}
...
function verificar_q7() {
    ...
    if (cpu.toUpperCase() == "CPU") {
        ...
        cpuP.innerHTML = `P`;
        cpuU.innerHTML = `U`;
        inp_cpu.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_cpu.style.border = 'solid 2px red';
        alert(`a resposta da questão 7 está incorreta!`)
    }
}
...
function verificar_q8() {
    ...
    if (adressBus.toUpperCase() == "ADRESS BUS") {
        ...
        inp_adressBus.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_adressBus.style.border = 'solid 2px red';
        alert(`a resposta da questão 8 está incorreta!`)
    }
}
...
function verificar_q9() {
    ...
    if (cache.toUpperCase() == "CACHE") {
        ...
        cacheH.innerHTML = `H`;
        cacheE.innerHTML = `E`;
        inp_cache.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_cache.style.border = 'solid 2px red';
        alert(`a resposta da questão 9 está incorreta!`)
    }
}
...
function verificar_q10() {
    ...
    if (i7.toUpperCase() == "I7") {
        registradoresI.innerHTML = `I`;
        i77.innerHTML = "7";
        inp_i7.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_i7.style.border = 'solid 2px red';
        alert(`a resposta da questão 10 está incorreta!`)
    }
}
...
function verificar_q11() {
    ...
    if (ula.toUpperCase() == "ULA") {
        ulaU.innerHTML = `U`;
        ulaL.innerHTML = "L";
        inp_ula.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_ula.style.border = 'solid 2px red';
        alert(`a resposta da questão 11 está incorreta!`)
    }
}
...
function verificar_q12() {
    ...
    if (eprom.toUpperCase() == "EPROM") {
        ...
        epromO.innerHTML = `O`;
        epromM.innerHTML = `M`;
        inp_eprom.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_eprom.style.border = 'solid 2px red';
        alert(`a resposta da questão 12 está incorreta!`)
    }
}
...
function verificar_q13() {
    ...
    if (i5.toUpperCase() == "I5") {
        i55.innerHTML = `5`;
        inp_i5.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_i5.style.border = 'solid 2px red';
        alert(`a resposta da questão 13 está incorreta!`)
    }
}
...
function verificar_q15() {
    ...
    if (dataBus.toUpperCase() == "DATA BUS") {
        ...
        inp_dataBus.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_dataBus.style.border = 'solid 2px red';
        alert(`a resposta da questão 15 está incorreta!`)
    }
}
...
function verificar_q16() {
    ...
    if (dma.toUpperCase() == "DMA") {
        ...
        epromM.innerHTML = `M`;
        dmaA.innerHTML = `A`;
        inp_dma.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_dma.style.border = 'solid 2px red';
        alert(`a resposta da questão 16 está incorreta!`)
    }
}
...
function verificar_q17() {
    ...
    if (flash.toUpperCase() == "FLASH") {
        ...
        adress_busS2.innerHTML = `S`;
        flashH.innerHTML = `H`;
        inp_flash.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_flash.style.border = 'solid 2px red';
        alert(`a resposta da questão 17 está incorreta!`)
    }
}
...
function verificar_q18() {
    ...
    if (cs.toUpperCase() == "CS") {
        csC.innerHTML = `C`;
        registradoresS2.innerHTML = `S`;
        inp_cs.style.border = 'solid 1px rgba(34, 14, 116)';
    } else {
        inp_cs.style.border = 'solid 2px red';
        alert(`a resposta da questão 18 está incorreta!`)
    }
}